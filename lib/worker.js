...
var STRIDER_CUSTOM_RULE = {
  filename: 'strider-custom.json',
  exists: true,
  language: 'node.js',
  framework: null,
  test: 'echo Delegating handling of strider-custom.json.',
  path: path.join(__dirname, '.')
};

var STRIDERFILE_RULE = {
...
function Worker(config) {
  ...
  this.rules = [STRIDER_CUSTOM_RULE, STRIDERFILE_RULE, NODE_RULE]
  this.hooks = []
