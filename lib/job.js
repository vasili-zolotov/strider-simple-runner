...
Job.prototype = {
  ...
  forkProc: function (cwd, command, args, next) {
    ...
    // generate a unique domain name for this github repo: branch.user.project
    var url_tokens = this.data.repo_ssh_url.replace('.git','').split('/').reverse();
    var repo = url_tokens[0];
    var user = url_tokens[1];
